    ...
    render() {
        return (
            <article className="article">
                <Link to={'/post/' + this.props.id} className="img__link"><img src={(this._reactInternalFiber.index == 0) ? this.props.img + '.jpg' : this.props.img + 'min.jpg'} className="article__img"/></Link>
